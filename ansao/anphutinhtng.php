<?php
// 
function an_phu_tinh_tng($thang,$ngay,$gio,&$obj_sao,&$obj_ngu_hanh){
	global $la_so_thien_ban;
	global $chi_nam;
	global $can_nam;
	global $sign;
$vi_tri_tuan1 = $chi_nam - $can_nam - 2;
$vi_tri_tuan2 = $chi_nam - $can_nam - 2;

$triet1=9-($can_nam+4)%5-1;
$triet2=9-($can_nam+4)%5-1;
